...
global.document = {
  ...
  createEvent: () => { throw new Error('TouchEvent not supported'); }
};
...
test('getCookieEnabled should return a boolean', () => {
  ...
  console.log('   getCookieEnabled returned:', enabled, 'type:', typeof enabled);
...
async function runAsyncTests() {
  ...
  try {
    ...
    assert(typeof result.fingerprint === 'string', 'fingerprint should be string');
    passed++;
